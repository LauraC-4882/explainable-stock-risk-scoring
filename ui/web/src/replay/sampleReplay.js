...
export const SAMPLE_REPLAY = {
  ...
  "steps": [
    ...
    },
    {
      ...
      "detail": {
        "reason": "chose research_more: perceived_risk=0.90, understanding=0.00, community_sentiment=+0.00, warning_taken_in=0.00, live_misconceptions=[score_is_advice, score_is_probability]",
